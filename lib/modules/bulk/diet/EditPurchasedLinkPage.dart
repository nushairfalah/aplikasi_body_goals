...
class EditPurchasedLinkPage extends StatelessWidget{
  const EditPurchasedLinkPage({super.key});
              ...
              Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      AdminTextField(label: "Link Update", hint: "",isImage: false,),
                      AdminTextField(label: "Image", hint: "wa.me/628",isImage: true,),
